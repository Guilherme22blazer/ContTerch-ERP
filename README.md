...
- Aba **ICMS Substituição Tributária (CEST)** — lista de mercadorias sujeitas a ST com 1.051 registros dos anexos do Convênio ICMS 142/2018, seleção de Estado de referência, pesquisa instantânea por NCM, CEST ou descrição, filtros pelos 25 segmentos, mercadorias sem classificação fiscal e venda porta a porta, paginação, detalhes, exportação JSON/CSV e links oficiais. O resultado deve ser cruzado com a descrição da mercadoria e a legislação da UF.
