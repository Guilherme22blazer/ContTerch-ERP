(function () {
  ...
  var ROUTE_MODULES = {
    inicio: 'tab_inicio',
    'sefaz-portal': 'tab_sefaz_portal', dashboard: 'tab_dashboard', diagnostico: 'tab_diagnostico',
  ...
  var MODULE_GROUPS = [
    ...
    { label: 'Área Fiscal', keys: ['tab_sefaz_portal', 'tab_dashboard', 'tab_diagnostico', 'tab_mei', 'tab_controle_mei', 'tab_obrigacoes', 'tab_ibs_cbs', 'tab_transicao_reforma', 'tab_lei_complementar', 'tab_mei_ibs_cbs', 'tab_parametros_2026', 'tab_consulta_cnpj', 'tab_inscricao_estadual', 'tab_cnae_servicos', 'tab_ncm_tipi', 'tab_consulta_cest', 'tab_cfop', 'tab_icms_difal', 'tab_aliquotas_beneficios', 'tab_aliquotas_iss', 'tab_simulador_locacao', 'tab_nbs_cclasstrib', 'tab_calculadora_tributaria', 'tab_cnpj_simples'] },
