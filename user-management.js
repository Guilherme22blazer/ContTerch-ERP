(function () {
  ...
  var ROUTE_MODULES = {
    ...
    'ponto-eletronico': 'tab_ponto_eletronico', 'banco-horas': 'tab_banco_horas', folha: 'tab_folha',
  ...
  var MODULE_GROUPS = [
    ...
    { label: 'RH & Departamento Pessoal', keys: ['tab_rh_dashboard', 'tab_colaboradores', 'tab_ferias', 'tab_afastamentos', 'tab_beneficios', 'tab_ponto_eletronico', 'tab_banco_horas'] },
